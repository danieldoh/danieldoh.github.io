...
![screen reader text](lizard_track_2.jpg "Figure 2: Black Dot Lizard Tracking in non-aerosol exposure chamber")


**Analysis**
- Indices: Analyzed lizard behavior using four indices:
  - Stride Speed
  - Movement
  - Speed
  - Leg Angle
- Visualization: Presented the analyzed data through visualizations.
