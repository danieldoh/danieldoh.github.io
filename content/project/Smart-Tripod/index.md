...
**ECE 49022 Senior Design Project**
...
- Designed and implemented a Hand Gesture Recognition system on the Raspberry Pi, involved developing and fine-tuning machine learning models to recognize and interpret various hand gestures.
- Inferred hand gesture using the [MediaPipe](https://developers.google.com/mediapipe) pre-trained model.
- Programmed timer and photo capture subsystem.